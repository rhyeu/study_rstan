...
N <- 50
I <- 120
d <- read.csv(file='ch.11/input/data-lda.txt')
...
ggsave(file='ch.11/output/fig11-6-left.png', plot=p, dpi=300, w=4, h=3)
...
ggsave(file='ch.11/output/fig11-6-right.png', plot=p, dpi=300, w=4, h=3)
