...
load('…/ch.8/output/result-model8-5.RData')
...
ggsave(file='…/ch.8/e/fig-ex3-a1.png', plot=p, dpi=300, width=4, height=5)
...
p <- p + labs(x='parameter', y='value')
ggsave(file='…/ch.8/e/fig-ex3-b1.png', plot=p, dpi=300, width=4, height=5)
