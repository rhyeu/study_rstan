...
load('ch.8/output/result-model8-8.RData')
...
ggsave(file='ch.8/output/fig8-9-left.png', plot=p, dpi=300, w=4, h=4)
...
ggsave(file='ch.8/output/fig8-9-right.png', plot=p, dpi=300, w=4, h=4)
