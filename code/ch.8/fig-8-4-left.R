...
load('ch.8/output/result-model8-1.RData')
load('ch.8/output/result-model8-2.RData')
load('ch.8/output/result-model8-3.RData')
...
p <- p + labs(y='a')
ggsave(file='ch.8/output/fig8-4-left.png', plot=p, dpi=300, w=4, h=3)
