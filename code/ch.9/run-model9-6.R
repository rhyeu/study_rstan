...
d_wide <- read.csv('ch.9/input/data-conc-2-NA-wide.txt')
N <- nrow(d_wide)
...
fit <- stan(file='ch.9/model/model9-6.stan', data=data, seed=123)

save.image('ch.9/output/result-model9-6.RData')
# write.table(d, file='ch.9/input/data-conc-2-NA-long.txt', sep=',', quote=FALSE, row.names=FALSE)
