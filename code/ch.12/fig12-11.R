...
load('ch.12/output/result-model12-14.RData')
ms <- rstan::extract(fit)

d_name <- read.csv('ch.12/input/data-map-UTF8.txt', header=FALSE, fileEncoding='UTF-8')
...
ggsave(file='ch.12/output/fig12-11-left.png', plot=p, dpi=300, w=4, h=4)
...
ggsave(file='ch.12/output/fig12-11-right.png', plot=p, dpi=300, w=4, h=4)
